...
4. You have cloned this repository (instructions are in the Analytical Platform User Guidance [here](https://user-guidance.services.alpha.mojanalytics.xyz/github.html#r-studio))
5. You have `s3tools` installed (you can check by running `library(s3tools)`, see [here](https://user-guidance.services.alpha.mojanalytics.xyz/data/amazon-s3/#rstudio) for how to install)
...
* To request access to the `alpha-r-training` bucket, get in touch with a member of the R Training Group
