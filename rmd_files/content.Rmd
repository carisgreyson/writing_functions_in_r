...
```{r, include=show_solution, purl=FALSE}
...
```{r, include=show_solution, purl=FALSE, eval = FALSE}
...
to vectorise multiple if-else statements, each with a different desired outcome. Load `dplyr` and run 
...
```{r fig.width=10, include=show_solution, purl=FALSE}
# Solution
